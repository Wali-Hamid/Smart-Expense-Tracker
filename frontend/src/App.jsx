...
//to get tranactions from localStorage
...
const App = () => {
  ...
  const handleLogin = (userData, remember = false, tokenFormApi = null) => {
    persistAuth(userData, tokenFormApi, remember);
    navigate("/");
  };

  const handleSignup = (userData, remember = false, tokenFormApi = null) => {
    persistAuth(userData, tokenFormApi, remember);
    navigate("/");
  };
