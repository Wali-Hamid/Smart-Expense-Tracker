...
import { ArrowDown, ArrowUp, HelpCircle, Home, LogOut, Menu,Wallet, User, X, } from 'lucide-react';
...
const MENU_ITEMS = [
  ...
  { text: "Expenses", path: "/expense", icon: <ArrowDown size={20} /> },
   { text: "Budget", path: "/budget", icon: <Wallet size={20} /> },
...
const initial = username.charAt(0).toUpperCase();
 ...
 // to check for overflow in mobile
  ...
  return (
    ...
    }} transition={{type: "string", damping:25}}
    >
...
<button onClick={toggleSidebar} className={sidebarStyles.toggleButton.base}>
    ...
    <div className={cn(
       ...
       )} to= "https://www.linkedin.com/in/wali-hamid-966553307/">
            ...
            >
              <div className='relative h-full flex flex-col'>
                ...
                <div className={sidebarStyles.mobileFooter}>
                  <Link to="" className={sidebarStyles.mobileFooterLink}>
