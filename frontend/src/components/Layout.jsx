...
import { ArrowDown, ArrowUp, Car, Clock, CreditCard, DollarSign, Gift, Home, Info, PiggyBank, RefreshCcw, ShoppingCart, TrendingUp, Utensils, Zap, RefreshCw, ChevronUp, ChevronDown, PieChart } from 'lucide-react';
...
//to Filter transactions monthy,weekly,daily
...
const fetchTransactions = async () => {
  ...
  // to add transcactions either income or expense
